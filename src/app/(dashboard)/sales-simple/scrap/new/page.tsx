...
export default function SimpleScrapSalePage() {
  ...
  const mutation = useMutation({
    mutationFn: async (data: Record<string, unknown>) => {
      const res = await fetch("/api/simple/sales/scrap", {
        method: "POST",
  ...
  return (
    <div className="p-4 md:p-8 pb-28 md:pb-8">
      <Breadcrumb items={[{ label: 'Dashboard', href: '/' }, { label: 'Sales', href: '/sales-simple' }, { label: 'Scrap Sale', href: null }]} />
