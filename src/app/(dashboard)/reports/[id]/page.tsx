...
function DetailRow({ label, value, mono, bold }: { label: string; value: string; mono?: boolean; bold?: boolean }) {
  return (
    <div className="flex justify-between items-center py-2 border-b border-outline-variant/30 last:border-b-0">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-3 mb-6">
        ...
        <div className="md:ml-auto flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-primary-container text-white font-bold text-sm rounded-lg hover:bg-primary-container/90 transition-all active:scale-95 shadow-sm"
          >
        ...
        <div className="bg-white rounded-xl border border-outline-variant shadow-sm overflow-hidden flex items-stretch">
          ...
          <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between flex-1 gap-6">
            <div>
              ...
              <h3 className={`font-mono text-3xl md:text-4xl font-bold tracking-tight ${isProfit ? "text-tertiary" : "text-[#ba1a1a]"}`}>
            ...
            <div className="grid grid-cols-2 gap-6 md:border-l md:border-outline-variant md:pl-8">
              <div>
                <p className="text-secondary text-[10px] font-bold uppercase tracking-wider">Total Income</p>
                <p className="font-mono text-xl font-semibold text-tertiary">{formatMoney(report.total_income)}</p>
              </div>
              <div>
          ...
          <div className="bg-white border border-outline-variant rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="px-5 md:px-6 pb-5 md:pb-6">
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest mb-1">
                <span className="text-secondary">Burnout Rate</span>
                <span className={parseFloat(report.burnout_percent) > 5 ? "text-warning" : "text-tertiary"}>
              ...
              <div className="h-2 w-full bg-surface-container-high rounded-full overflow-hidden">
                <div
                  className={`h-full rounded-full transition-all duration-500 ${
                    parseFloat(report.burnout_percent) > 5 ? "bg-warning" : "bg-tertiary"
                  }`}
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white border border-outline-variant rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-1">
              ...
              <div className="flex justify-between items-center pt-3 mt-1 border-t-2 border-primary-container/10">
                <span className="font-display font-bold text-primary-container text-sm">Total Income</span>
                <span className="font-display font-bold text-lg text-tertiary">{formatMoney(report.total_income)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-outline-variant rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-1">
              ...
              <div className="flex justify-between items-center pt-3 mt-1 border-t border-outline-variant">
                <span className="font-display font-bold text-primary-container text-sm">Total Cost</span>
          ...
          {/* Report Meta */}
          <div className="text-xs text-secondary flex flex-wrap items-center gap-x-4 gap-y-1">
