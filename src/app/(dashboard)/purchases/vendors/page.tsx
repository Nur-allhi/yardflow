                  ...
                  {paginatedVendors.map((v) => {
                    ...
                    return (
                      <tr key={v.id} className="hover:bg-[#f7f9fb] transition-colors">
                        <td className="px-6 py-5 text-sm font-bold text-[#0F172A]">{v.name}</td>
                        ...
                        <td className="px-6 py-5 text-right">
                          <div className="flex justify-end items-center gap-4">
                            <Link href={`/purchases?vendor_id=${v.id}`} className="text-[#059669] font-bold hover:underline decoration-2 text-sm">
                              View
                            </Link>
                            {v.due_balance > 0 ? (
                ...
                <div key={v.id} className="bg-white p-4 rounded-xl border border-[#c6c6cd]/30 shadow-sm space-y-3">
                  <div className="flex justify-between items-start">
                    <div className="space-y-1.5">
                      <h3 className="font-display font-bold text-base text-[#0F172A]">{v.name}</h3>
                  ...
                  <div className="flex gap-2 pt-1">
                    <Link href={`/purchases?vendor_id=${v.id}`} className="block flex-1 py-2.5 rounded-lg border border-[#0F172A] text-[#0F172A] font-bold text-sm transition-colors hover:bg-[#f2f4f6] active:scale-[0.98] text-center">
                      View
                    </Link>
                    {v.due_balance > 0 ? (
