# YardFlow ERP Design System

## Overview

YardFlow ERP is a practical, no-nonsense design system built for
industrial business management in the iron and YardFlow trade.
Its foundation reflects the workshop floor — structured, weight-bearing,
and built to last. The system prioritizes clarity at a glance, fast data
entry, and trustworthy numbers across every module, from stock ledgers
to payroll — turning what was once a pile of paper records into a single,
